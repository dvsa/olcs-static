	...
	<body>
		...
		<div class="main">
			...
			<div class="vertical-navigation" role="navigation">
				<h3 class="vertical-navigation__title">Title</h3>
				<ol>
					<li class="vertical-navigation__item"><a href="#postal-address">Postal address</a></li>
					<li class="vertical-navigation__item"><a href="#personal-information">Personal information</a></li>
					<li class="vertical-navigation__item"><a href="#about-you">About you</a></li>
				</ol>
			</div>
			...
			<form> 
				...
				<fieldset>
					<legend id="postal-address">Postal address</legend>
					<div class="field">
				...
				<fieldset>
					<legend id="personal-information">Personal information</legend>
					<div class="field">
				...
				<fieldset>
					<legend id="about-you">About you</legend>
					<fieldset>
